document.addEventListener('DOMContentLoaded', function () {
    ...
    options: {
      scales: {
        y1: {
          ...
          title: {
            text: 'MSW per capita (kg/person/day)',
            display: true,
          },
        },
        y: {
  ...
  new Chart(ctx4, {
    ...
    data: {
      ...
      datasets: [
        {
          data: [46.69, 4.13, 15.6, 10.6, 3.6, 19.38],
  ...
  const chart3_data = [
    ...
    { tooltip: 'Virgin Islands (U.S.)', urbanization_rate: 94.761, waste: 1388.888889 },
        ...
        annotation: {
          annotations: {
            line1: {
              ...
              label: {
                display: true,
                content: (ctx) => 'Global Average: ' + average(ctx).toFixed(2),
                position: 'end',
              },
              scaleID: 'y',
  ...
  const labels_for_chart6 = ['2020 Baseline', '2050 WMaU', '2050 WuC', '2050 CWM'];
